    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Available', 'Available'), ('Claimed', 'Claimed'), ('In Review', 'In Review'), ('Completed', 'Completed'), ('Cancelled', 'Cancelled')], default='Available', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_trees', to='product_management.product')),
            ],
            options={
                'ordering': ('-created_at',),
                'abstract': False,
