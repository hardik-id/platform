    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="items", to="commerce.bountycart"
            ),
        ),
        migrations.AddField(
            model_name="bountycart",
        ...
        migrations.AddField(
            ...
            name="bounty_cart",
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, related_name="platform_fee", to="commerce.bountycart"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="bounty_cart",
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, related_name="point_order", to="commerce.bountycart"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="bounty_cart",
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.PROTECT, related_name="sales_order", to="commerce.bountycart"
            ),
        ),
        migrations.AddField(
            model_name="salesorder",
