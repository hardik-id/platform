...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="platformfeecartitem",
            name="cart",
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, related_name="platform_fee_item", to="commerce.cart"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="bounty",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="product_management.bounty"
            ),
        ),
        migrations.AddField(
            model_name="salesorderlineitem",
        ...
        migrations.AddField(
            model_name="salestaxcartitem",
            name="cart",
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, related_name="sales_tax_item", to="commerce.cart"
            ),
        ),
    ]
